...
class Attention(nn.Module):
    def __init__(self, dim, num_heads=8, qkv_bias=False, attn_drop=0., proj_drop=0., use_lora=False, attention_mode='math'):
        ...
        if attention_mode == 'xformers' and not XFORMERS_IS_AVAILABLE:
            attention_mode = 'math'
...
def Dome_XL_2(**kwargs):
    return Dome(depth=28, hidden_size=1152, patch_size=2, num_heads=16, **kwargs)

def Dome_XL_4(**kwargs):
    return Dome(depth=28, hidden_size=1152, patch_size=4, num_heads=16, **kwargs)

def Dome_XL_8(**kwargs):
    return Dome(depth=28, hidden_size=1152, patch_size=8, num_heads=16, **kwargs)

def Dome_L_2(**kwargs):
    return Dome(depth=24, hidden_size=1024, patch_size=2, num_heads=16, **kwargs)

def Dome_L_4(**kwargs):
    return Dome(depth=24, hidden_size=1024, patch_size=4, num_heads=16, **kwargs)

def Dome_L_8(**kwargs):
    return Dome(depth=24, hidden_size=1024, patch_size=8, num_heads=16, **kwargs)

def Dome_B_2(**kwargs):
    return Dome(depth=12, hidden_size=768, patch_size=2, num_heads=12, **kwargs)

def Dome_B_4(**kwargs):
    return Dome(depth=12, hidden_size=768, patch_size=4, num_heads=12, **kwargs)

def Dome_B_8(**kwargs):
    return Dome(depth=12, hidden_size=768, patch_size=8, num_heads=12, **kwargs)

def Dome_S_2(**kwargs):
    return Dome(depth=12, hidden_size=384, patch_size=2, num_heads=6, **kwargs)

def Dome_S_4(**kwargs):
    return Dome(depth=12, hidden_size=384, patch_size=4, num_heads=6, **kwargs)

def Dome_S_8(**kwargs):
    return Dome(depth=12, hidden_size=384, patch_size=8, num_heads=6, **kwargs)
