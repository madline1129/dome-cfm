...
CFG="${CFG:-./config/train_dome_cfmv5_resample.py}"
WORK_DIR="${WORK_DIR:-./work_dir/dome-cfmv5_resample}"
...
echo "[任务] Resample dome-cfmv5 joint flow: occupancy latent + trajectory tokens"
echo "[配置] $CFG"
echo "[输出] $WORK_DIR"
