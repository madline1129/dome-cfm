...
CFG="${CFG:-./config/train_dome_joint_flow_v3_resample.py}"
WORK_DIR="${WORK_DIR:-./work_dir/dome_joint_flow_v3_resample}"
...
echo "[任务] DOMEv3 joint flow matching: occupancy latent + trajectory latent tokens"
echo "[配置] $CFG"
echo "[输出] $WORK_DIR"
